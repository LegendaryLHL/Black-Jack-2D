...
namespace BlackJack2D
{
    class BlackJack2DGame : GameEngine
    {
        ...
        {
            //View Card Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("ViewDeckCardsButtonHover"))
            {
                ButtonHover = "";
                ViewDeckCards.ViewDeckCardsFunction();
            }
            //Shuffle Cards Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("ShuffleDeckButtonHover"))
            {
                ButtonHover = "";
                ViewDeckCards.ShuffleDeckFunction();
            }
            //Back Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("BackButtonHover"))
            {
                ButtonHover = "";
                ViewDeckCards.BackFunction();
            }
            //Rearrange Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("RearrangeButtonHover"))
            {
                ButtonHover = "";
                ViewDeckCards.RearrangeFunction();
            }
            //Play Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("PlayButtonHover"))
            {
                ButtonHover = "";
                BlackJack2DCode.PlayFunction();
            }
            //Quit Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("QuitButtonHover"))
            {
                ButtonHover = "";
                Application.Exit();
            }
            //Shop Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("ShopButtonHover"))
            {
                ButtonHover = "";
                Shop.ShopFunction();
            }
            //Upgrade Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("UpgradeButtonHover"))
            {
                ButtonHover = "";
                //upgrade function;
            }
            ...
            //_50 Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_50Hover") && BlackJack2DCode.Money >= 50)
            {
            ...
            //_100 Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_100Hover") && BlackJack2DCode.Money >= 100)
            {
            ...
            //_200 Button Up
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_200Hover") && BlackJack2DCode.Money >= 200)
            {
            ...
            //_500
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_500Hover") && BlackJack2DCode.Money >= 500)
            {
            ...
            //_1000
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_1000Hover") && BlackJack2DCode.Money >= 1000)
            {
            ...
            //_5000
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_5000Hover") && BlackJack2DCode.Money >= 5000)
            {
            ...
            //_10000
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_10000Hover") && BlackJack2DCode.Money >= 10000)
            {
            ...
            //_100000
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_100000Hover") && BlackJack2DCode.Money >= 100000)
            {
            ...
            //_1000000
            if (e.Button == MouseButtons.Left && Sprite2D.CursorIsOnGraphicElement("_1000000Hover") && BlackJack2DCode.Money >= 1000000)
            {
        ...
        public void CheakHover()
        {
            ...
            if (Sprite2D.CursorIsOnGraphicElement("ViewDeckCardsButton") && ButtonHover == "")
            {
                ButtonHover = "ViewDeckCardsButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("ViewDeckCardsButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("ViewDeckCardsButtonHover") && ButtonHover == "ViewDeckCardsButton")
            {
                ButtonHover = "";
            ...
            if (Sprite2D.CursorIsOnGraphicElement("ShuffleDeckButton") && ButtonHover == "")
            {
            ...
            //Back Button Hover
            if (Sprite2D.CursorIsOnGraphicElement("BackButton") && ButtonHover == "")
            {
                ButtonHover = "BackButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("BackButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("BackButtonHover") && ButtonHover == "BackButton")
            {
                ButtonHover = "";
            ...
            if (Sprite2D.CursorIsOnGraphicElement("RearrangeButton") && ButtonHover == "")
            {
                ButtonHover = "RearrangeButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("RearrangeButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("RearrangeButtonHover") && ButtonHover == "RearrangeButton")
            {
                ButtonHover = "";
            ...
            //Play Button Hover
            if (Sprite2D.CursorIsOnGraphicElement("PlayButton") && ButtonHover == "")
            {
                ButtonHover = "PlayButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("PlayButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("PlayButtonHover") && ButtonHover == "PlayButton")
            {
                ButtonHover = "";
            ...
            //Quit Button Hover
            if (Sprite2D.CursorIsOnGraphicElement("QuitButton") && ButtonHover == "")
            {
                ButtonHover = "QuitButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("QuitButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("QuitButtonHover") && ButtonHover == "QuitButton")
            {
                ButtonHover = "";
            ...
            //Shop Button Hover
            if (Sprite2D.CursorIsOnGraphicElement("ShopButton") && ButtonHover == "")
            {
                ButtonHover = "ShopButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("ShopButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("ShopButtonHover") && ButtonHover == "ShopButton")
            {
                ButtonHover = "";
            ...
            if (Sprite2D.CursorIsOnGraphicElement("UpgradeButton") && ButtonHover == "")
            {
                ButtonHover = "UpgradeButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("UpgradeButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("UpgradeButtonHover") && ButtonHover == "UpgradeButton")
            {
                ButtonHover = "";
            ...
            //Hit Button Hover
            if (Sprite2D.CursorIsOnGraphicElement("HitButton") && ButtonHover == "")
            {
                ButtonHover = "HitButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("HitButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("HitButtonHover") && ButtonHover == "HitButton")
            {
                ButtonHover = "";
            ...
            //Stay Button Hover
            if (Sprite2D.CursorIsOnGraphicElement("StayButton") && ButtonHover == "")
            {
                ButtonHover = "StayButton";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("StayButtonHover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("StayButtonHover") && ButtonHover == "StayButton")
            {
                ButtonHover = "";
            ...
            //_0 Hover
            if (Sprite2D.CursorIsOnGraphicElement("_0") && ButtonHover == "")
            {
                ButtonHover = "_0";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_0Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_0Hover") && ButtonHover == "_0")
            {
                ButtonHover = "";
            ...
            //_50 Hover
            if (Sprite2D.CursorIsOnGraphicElement("_50") && ButtonHover == "")
            {
                ButtonHover = "_50";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_50Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_50Hover") && ButtonHover == "_50")
            {
                ButtonHover = "";
            ...
            //_100 Hover
            if (Sprite2D.CursorIsOnGraphicElement("_100") && ButtonHover == "")
            {
                ButtonHover = "_100";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_100Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_100Hover") && ButtonHover == "_100")
            {
                ButtonHover = "";
            ...
            //_200 Hover
            if (Sprite2D.CursorIsOnGraphicElement("_200") && ButtonHover == "")
            {
                ButtonHover = "_200";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_200Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_200Hover") && ButtonHover == "_200")
            {
                ButtonHover = "";
            ...
            //_500 Hover
            if (Sprite2D.CursorIsOnGraphicElement("_500") && ButtonHover == "")
            {
                ButtonHover = "_500";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_500Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_500Hover") && ButtonHover == "_500")
            {
                ButtonHover = "";
            ...
            //_5000 Hover
            if (Sprite2D.CursorIsOnGraphicElement("_5000") && ButtonHover == "")
            {
                ButtonHover = "_5000";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_5000Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_5000Hover") && ButtonHover == "_5000")
            {
                ButtonHover = "";
            ...
            //_10000 hover
            if (Sprite2D.CursorIsOnGraphicElement("_10000") && ButtonHover == "")
            {
                ButtonHover = "_10000";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_10000Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_10000Hover") && ButtonHover == "_10000")
            {
                ButtonHover = "";
            ...
            //_100000
            if (Sprite2D.CursorIsOnGraphicElement("_100000") && ButtonHover == "")
            {
                ButtonHover = "_100000";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_100000Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_100000Hover") && ButtonHover == "_100000")
            {
                ButtonHover = "";
            ...
            //_1000000 Hover
            if (Sprite2D.CursorIsOnGraphicElement("_1000000") && ButtonHover == "")
            {
                ButtonHover = "_1000000";
                AllGraphicElements[ButtonHover].DestroySelf();
                new Sprite2D("_1000000Hover");
            }
            if (!Sprite2D.CursorIsOnGraphicElement("_1000000Hover") && ButtonHover == "_1000000")
            {
                ButtonHover = "";
